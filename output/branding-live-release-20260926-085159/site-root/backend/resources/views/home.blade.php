...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/png" href="/images/FMRC%20Brand%20Logo.png?v=1" />
    <link rel="apple-touch-icon" href="/images/FMRC%20Brand%20Logo.png?v=1" />
    ...
    <link rel="stylesheet" href="{{ asset('frontend/home-page/main.css') }}?v=1.1" />
  </head>
  <body>
    <header class="site-header">
      <a href="main.html" class="logo-container">
        <span class="header-logo-pair" aria-hidden="true">
          <img src="/images/UCN Logo.png" alt="" class="header-emblem" />
          <img src="/images/FMRC Brand Logo.png" alt="" class="header-emblem" />
        </span>
    ...
    <main class="hero-section" id="home">
      <div class="hero-container">
        ...
        <div class="hero-content-right">
          <img
            src="/images/FMRC Brand Logo.png"
    ...
    <script src="{{ asset('frontend/home-page/main.js') }}?v=9.5"></script>
  </body>
</html>
