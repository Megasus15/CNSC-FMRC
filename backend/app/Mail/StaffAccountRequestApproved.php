...
class StaffAccountRequestApproved extends Mailable
{
     ...
     * admin-editable `staff_request_approved` template. The account summary,
     * the sign-in call to action, the forgotten-password reassurance and the
     * Reach Us Anytime table are code-owned.
     *
    ...
    private function buildHtml(): string
    {
        ...
        $accent = EmailTemplate::color(EmailTemplate::resolve('staff_request_approved')['header_color']);
        $success = '#0f7b52';
...
HTML;
        ...
        return EmailTemplate::render('staff_request_approved', [
